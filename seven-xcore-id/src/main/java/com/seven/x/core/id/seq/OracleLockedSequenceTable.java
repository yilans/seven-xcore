...
/**
 * Oracle对应的加锁查询ID语句以及初始化语句
 * @author zhang.jun
 * 2015年6月17日
 */
public class OracleLockedSequenceTable extends AbstractLockedSequenceTable{
	...
	public void init() {
		...
		try {
			...
			String str = "CREATE TABLE " + this.tableName + "("
					...
					+ " NUMBER, DATETIME DATE,  CONSTRAINT PK_SEQ_NO PRIMARY KEY("
					+ this.typeColume + "))";
